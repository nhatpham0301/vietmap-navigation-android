...
import static vn.vietmap.services.android.navigation.v5.navigation.NavigationConstants.ManeuverModifier;
import static vn.vietmap.services.android.navigation.v5.navigation.NavigationConstants.ManeuverType;
...
public class ManeuverView extends View {
    ...
    private void initializeColorFrom(AttributeSet attributeSet) {
        ...
        primaryColor = typedArray.getColor(R.styleable.ManeuverView_maneuverViewPrimaryColor,
            ContextCompat.getColor(getContext(), R.color.vietmap_navigation_view_color_banner_maneuver_primary));
        secondaryColor = typedArray.getColor(R.styleable.ManeuverView_maneuverViewSecondaryColor,
            ContextCompat.getColor(getContext(), R.color.vietmap_navigation_view_color_banner_maneuver_secondary));
        typedArray.recycle();
    }
