...
class RouteConstants {
  static final String VIETMAP_LOCATION = "vietmap-location";
  static final String CONGESTION_KEY = "congestion";
  static final String ROUTE_SOURCE_ID = "vietmap-navigation-route-source";
  static final String ROUTE_LAYER_ID = "vietmap-navigation-route-layer";
  static final String ROUTE_SHIELD_LAYER_ID = "vietmap-navigation-route-shield-layer";
  static final String WAYPOINT_SOURCE_ID = "vietmap-navigation-waypoint-source";
  static final String WAYPOINT_LAYER_ID = "vietmap-navigation-waypoint-layer";
  static final int TWO_POINTS = 2;
  static final int THIRTY = 30;
  static final String ARROW_BEARING = "vietmap-navigation-arrow-bearing";
  static final String ARROW_SHAFT_SOURCE_ID = "vietmap-navigation-arrow-shaft-source";
  static final String ARROW_HEAD_SOURCE_ID = "vietmap-navigation-arrow-head-source";
  static final String ARROW_SHAFT_CASING_LINE_LAYER_ID = "vietmap-navigation-arrow-shaft-casing-layer";
  static final String ARROW_SHAFT_LINE_LAYER_ID = "vietmap-navigation-arrow-shaft-layer";
  static final String ARROW_HEAD_ICON = "vietmap-navigation-arrow-head-icon";
  static final String ARROW_HEAD_ICON_CASING = "vietmap-navigation-arrow-head-icon-casing";
  static final int MAX_DEGREES = 360;
  static final String ARROW_HEAD_CASING_LAYER_ID = "vietmap-navigation-arrow-head-casing-layer";
  static final Float[] ARROW_HEAD_CASING_OFFSET = {0f, -7f};
  static final String ARROW_HEAD_LAYER_ID = "vietmap-navigation-arrow-head-layer";
  ...
  static final String LAYER_ABOVE_UPCOMING_MANEUVER_ARROW = "vn.vietmap.annotations.points";
