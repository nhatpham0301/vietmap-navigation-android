...
import static vn.vietmap.services.android.navigation.v5.navigation.NavigationHelper.checkMilestones;
import static vn.vietmap.services.android.navigation.v5.navigation.NavigationHelper.isUserOffRoute;
...
public class NavigationHelperTest extends BaseTest {
    ...
    public void checkMilestones_onlyTriggeredMilestonesGetReturned() throws Exception {
        ...
        VietmapNavigation vietmapNavigation = new VietmapNavigation(context, options, mock(LocationEngine.class));
        vietmapNavigation.addMilestone(new StepMilestone.Builder()
        ...
        List<Milestone> triggeredMilestones = checkMilestones(routeProgress, routeProgress, vietmapNavigation);
    ...
    public void offRouteDetectionDisabled_isOffRouteReturnsFalse() throws Exception {
        ...
        when(context.getApplicationContext()).thenReturn(mock(Context.class));
        VietmapNavigation vietmapNavigation = new VietmapNavigation(context, options, mock(LocationEngine.class));
        NavigationLocationUpdate model = NavigationLocationUpdate.create(mock(Location.class), vietmapNavigation);
